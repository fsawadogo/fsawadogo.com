...
const translations = {
  en: {
    ...
    'courses-ds': "Machine Learning, Deep Learning, Statistical Analysis, Big Data Analytics, Neural Networks",
  ...
  fr: {
    ...
    'courses-ds': "Apprentissage automatique, Deep Learning, Analyse statistique, Analytique Big Data, Réseaux neuronaux",
